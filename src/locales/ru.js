export default {
  assets: {
    ...
    delete_error:
      'Ошибка при удалении ассета. Скорее всего к нему привязаны какие-то данные. Вы уверены что этот ассет не связан с существующей задачей?',
    delete_text: 'Уверены, что хотите удалить {name} из базы данных?',
    edit_fail:
      'Не удалось сохранить. Возможно, что ассет с таким же именем уже существует.',
  ...
  asset_types: {
    ...
    create_error:
      'Ошибка при сохранении этого типа ассетов. Вы уверены, что нет типа ассетов с таким же названием?',
    delete_text: 'Вы уверены, что хотите удалить {name} из базы данных?',
    delete_error:
      'Ошибка при удалении этого типа ассетов. Скорее всего к нему привязаны какие-то данные. Вы уверены, что к этому типу не привязан какой-либо ассет?',
  ...
  comments: {
    ...
    edit_error:
      'Ошибка при редактировании комментария. Пожалуйста, обратитесь в поддержку.',
  ...
  custom_actions: {
    create_error:
      'Ошибка при сохранении специального действия. Вы уверены, что нет действия с таким же названием?',
    delete_text:
      'Уверены, что хотите удалить специальное действие {name} из базы данных?',
  ...
  entities: {
    ...
    thumbnails: {
      ...
      explaination:
        'Для добавления ярлыка нужно новое превью. Чтобы сделать сразу несколько ярлыков, необходимо сначала выбрать тип задачи для создания новых превью. Ярлыки будут сделаны на основании этого нового превью.',
      explaination_two:
        'Далее выберите файлы для загрузки. Чтобы найти правильные объекты, имена файлов должны соответсвовать маске:',
  ...
  episodes: {
    ...
    edit_error:
      'Ошибка при сохранении этого эпизода. Вы уверены, что нет эпизода с таким же названием?',
    delete_error:
      'Ошибка при удалении этого эпизода. Вероятнее всего к нему привязаны какие-то данные. Вы уверены, что этот тип ассетов не связан с какой-либо секвенция?',
    delete_text:
      'Уверены, что хотите удалить {name} из базы данных? Каждый связаный шот и превью будет удален. Пожалуйста, введите название эпизода для подтверждения.',
  ...
  login: {
    ...
    login: 'Войти',
    login_failed:
      'Ошибка входа. Пожалуйста, проверьте ваши имя пользователя и пароль',
    login_page: 'Отмена',
    ...
    reset_change_password_form_failed:
      'С паролем, который вы дали, возникла проблема. Убедитесь в том, что он состоит как минимум из 7 знаков и что оба пароля совпадают',
    reset_change_password_failed:
      'Не удалось изменить пароль. Пожалуйста, пройдите процедуру ещё раз.',
    reset_change_password_succeed:
      'Ваш пароль успешно изменён. Пожалуйста вернитесь на страницу логина, чтобы использовать его.',
    reset_change_password_title: 'Введите новый пароль',
    reset_password: 'Сбросить Пароль',
    reset_password_failed:
      'Ошибка при сбросе пароля. Проверьте правильность указанной почты.',
    reset_password_succeed:
      'Пароль успешно сброшен. Пожалуйста, проверьте вашу почту.',
  ...
  main: {
    ...
    csv: {
      ...
      preview_description:
        'Загрузить .csv файл чтобы наполнить доску записями.',
  ...
  notifications: {
    ...
    unread_notifications:
      'непрочитанное уведомление | непрочитанные уведомления',
    title: 'Уведомления',
  ...
  people: {
    ...
    create_error:
      'Произошла ошибка при создании этого пользователя. Свяжитесь с поддержкой.',
    delete_error:
      'Произошла ошибка при удалении этого пользователя. Скорее всего с ним связаны какие-то данные. Вы уверены что этого пользователь не участвует в задачах или не оставлял комментариев?',
    delete_text:
      'Вы уверены что хотите удалить {personName} из базы данных? Каждый связанный комментарий и превью будет удален. Пожалуйста, для подтверждения введите полное имя пользователя.',
  ...
  playlists: {
    ...
    apply_task_type_change:
      'Выбрать последнюю версию для типа задачи на всех шотах.',
    ...
    loading_error:
      'На сервере произошла ошибка. Не получилось загрузить плейлисты.',
  ...
  productions: {
    ...
    delete_text:
      'Вы уверены что хотите удалить {name} из базы данных? Пожалуйста, для подтверждения введите название проекта в текстовом поле.',
    delete_error:
      'Возникла ошибка при удалении проекта. Скорее всего к нему привязаны какие-то данные. Вы уведомления что к этому проекту не привязаны задачи, шоты или ассеты? Kitsu не позволяет удалять не пустые проекты. Если вы больше не хотите видеть это проект, можете закрыть его вместо удаления.',
    edit_error:
      'Возникла ошибка при редактировании проекта. Обратитесь в поддержку.',
    ...
    home: {
      ...
      no_prod_for_client:
        'У вас нет доступа к проектам. Обратитесь к заказчику для получения доступа.',
    ...
    metadata: {
      ...
      delete_text:
        'Уверены, что хотите удалить этот столбец и связанные данные для всех ассетов этого проекта?',
      delete_error: 'Ошибка при удалении этого столбца метаданных.',
      error:
        'Ошибка при добавлении столбца метаданных. Убедитесь, нет ли уже столбца с таким названием и что все строки заполнены. Если проблема осталась, обратитесь в поддержку.',
  ...
  profile: {
    ...
    change_password: {
      ...
      unvalid:
        'Введенные пароли не совпадают или пароль слишком короткий (нужно не менее 7-ми символов).'
    },
    save: {
  ...
  settings: {
    ...
    fields: {
      ...
      use_original_name:
        'Использовать оригинальное название файла при скачивании'
    },
    production: {
      empty_list:
        'Список пуст. Это значит, что все данные основных настроек доступны пользователям. Внесите изменения, чтобы ограничить доступ к этому проекту.'
    },
    save: {
  ...
  task_status: {
    create_error:
      'Ошибка при сохранении этого статуса задачи. Вы уверены, что нет статуса с таким же названием?',
    delete_text: 'Уверены, что хотите удалить {name} из базы данных?',
    delete_error:
      'Ошибка при удалении статуса задачи. Вероятнее всего к нему привязаны какие-то данные. Вы уверены, что этот статус не связан с какой-либо задачей?',
  ...
  task_types: {
    delete_text: 'Уверены, что хотите удалить {name} из базы данных?',
    delete_error:
      'Ошибка при удалении этого типа задач. Вероятнее всего к нему привязаны какие-то данные. Вы уверены, что этот статус не связан с какой-либо задачей?',
    edit_title: 'Редактировать тип задачи',
    create_error:
      'Ошибка при создании типа задач. Убедитесь, нет ли уже типа задач с таким же названием.',
  ...
  sequences: {
    ...
    edit_error:
      'Ошибка при сохранении этой секвенции. Вы уверены, что нет секвенции с таким же названием?',
    delete_text:
      'Уверены, что хотите удалить {name} из базы данных? Все связанные шоты и превью будут удалены. Для подтверждения введите название секвенции.',
    delete_error:
      'Ошибка при удалении секвенции. Вероятнее всего к нему привязаны какие-то данные. Вы уверены, что эта секвенция не связана с каким-либо шотом?',
  ...
  schedule: {
    ...
    milestone: {
      ...
      name: 'Назв',
      error:
        'Ошибка при добавлении или редактировании этапа. Повторите попытку.'
    }
  },
  ...
  tasks: {
    ...
    create_tasks_shot_explaination:
      'Вы хотите создать новые задачи данного типа для каждого шота текущего проекта. Продолжить?',
    ...
    create_tasks_asset_explaination:
      'Вы создадите новые задачи данного типа для каждого ассета текущего проекта. Продолжить?',
    create_tasks_asset_failed: 'Ошибка сервера при создании задач для ассетов.',
    current: 'Текущая задача',
    current_status: 'Текущий статус:',
    delete_all_text:
      'Уверены, что хотите удалить все задачи типа {name}? Для подтверждения введите названия типа задач, которые хотите удалить.',
    ...
    select_preview_file:
      'Выберите изображение с диска для использования в качестве превью текущей задачи',
    ...
    select_image_file:
      'Выберите изображение с диска, которе вы хотите прикрепить к комментарию.',
    tasks: 'Задачи',
