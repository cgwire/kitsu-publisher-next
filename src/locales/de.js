export default {
  ...
  login: {
    ...
    reset_change_password_form_failed:
      "Es gibt ein Problem mit dem von dir angegebenen Passwort. Bitte überprüfen Sie, ob es mindestens 7 Zeichen lang ist und ob beide Passwörter übereinstimmen.",
  ...
  people: {
    ...
    csv: {
      ...
      error_upload:
        "Beim Hochladen Ihrer CSV-Datei ist ein Fehler aufgetreten.",
    },
    fields: {
      first_name: "Vorname",
      last_name: "Nachname",
  ...
  profile: {
    ...
    change_password: {
      ...
      unvalid:
        "Deine neue Passwort-Bestätigung stimmt nicht oder dein Passwort ist zu kurz (es werden mindestens 7 Zeichen erwartet).",
    },
    save: {
